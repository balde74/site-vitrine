...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
		...
		<div class="x_content">
			...
			<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('section-menu.store') }}" enctype="multipart/form-data">
			...
			@csrf
				...
				<input type="number" name="menu_id" value="{{ $menu->id }}" class="d-none">
