...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
		<div class="x_title">
			<h2>Ajouter un slogan</h2>
			<div class="clearfix"></div>
		</div>
		<div class="x_content">
			<br />
			<form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('slogan.store') }}" enctype="multipart/form-data">
			...
			@csrf
                ...
                <div class="item form-group">
                    ...
                    <textarea name="texte" required="required" class="form-control summernote {{ $errors->has('texte') ? ' is-invalid' : '' }}" cols="30" rows="5" style="resize: none;" >{{ old('texte') }}</textarea>
                        @if ($errors->has('texte'))
				...
				<div class="item form-group">
					...
					<div class="col-md-8 col-sm-8 ">
					<input type="text" name="icone" id="first-name" class="form-control {{ $errors->has('icone') ? ' is-invalid' : '' }}" value="{{ old('icone') }}" autocomplete="off">
					@if ($errors->has('icone'))
	                    <span class="invalid-feedback" role="alert">
