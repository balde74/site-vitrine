...
<section class="section about position-relative">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<img src="{{asset('documents/'.$info->mot_directeur_image)}}" alt="" width="100%" style="position:relative;">

			</div>
			<div class="col-md-6 offset-md-6 offset-md-0">
				<div class="about-item ">
					...
					<div class="about-content">
						<h4 class="mb-3 position-relative text-color">Mot du directeur</h4>
